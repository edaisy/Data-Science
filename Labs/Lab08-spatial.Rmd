...
path_in <- "/Users/evandaisy/Applications/Git/Data-Science/data"
...
> ANSWER: There are far more institutions listed in the IPEDS dataset because they have information on every institution in the US, but this shouldn't be much of a problem, especially if we use inner_join to join the two datasets. As for the multiple campus mismatches, we could duplicate the listing in the Chronicle dataset whichever number of times is necessary to match the IPEDS one.
