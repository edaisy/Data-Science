...
> ANSWER: The distribution of term length for US supreme court justices is fairly bimodal and right-skewed, with modes at around seven years and around 15 years. This indicates that although most justices have retired after around 7 or 15 years, some have continued to serve far longer.

```{r}
justices <- read_csv("/Users/evandaisy/Applications/Git/Data-Science/Homework/justice.csv")
...
ggplot(justices2, aes(x = tenure_length)) + 
  geom_density() + 
  xlab("Tenure Length (Years)") + 
  labs(title = "Tenure Length of United States Supreme Court Justices")
```
...
```{r, linewidth = 60}
quotes <- read_csv("/Users/evandaisy/Applications/Git/Data-Science/Homework/quotes.csv")

quotes_for_the_day <- quotes[sample(1:nrow(quotes), size = 3),]

cat(quotes_for_the_day[1]$together) 


cat(quotes_for_the_day[2]$together) 


cat(quotes_for_the_day[3]$together)
```
